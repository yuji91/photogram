...
heroku config:add FACEBOOK_ID_PRODUCTION=525550474450105
heroku config:add FACEBOOK_SECRET_PRODUCTION=38d8dff0ec7cc6951c40acecca8ecacd
heroku config:add TWITTER_ID_PRODUCTION=Tj6Nkso40fYeYbZKETQvoF2pQ
heroku config:add TWITTER_SECRET_PRODUCTION=4y8Otk5hU2oXOnK8DrMVSBz6MkKSqbHlm6IVIUqtGoBS4gnktw
...
rails g model Picture title:text user:references
